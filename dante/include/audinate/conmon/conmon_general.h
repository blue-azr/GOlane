 ...
 */
#define CONMON_VERSION_MINOR  2

/**
 * The bugfix version of this conmon release
 */
#define CONMON_VERSION_BUGFIX 0
...
enum conmon_channel_type
{
	...
	CONMON_CHANNEL_TYPE_MONITORING,       // DEPRECATED - use CONMON_CHANNEL_TYPE_TELEMETRY instead
	CONMON_CHANNEL_TYPE_TELEMETRY=        // telemetry messages        [unicast+multicast TX, unicast or multicast RX]
		CONMON_CHANNEL_TYPE_MONITORING,   //   (New, less ambigous name for monitoring channel)
	CONMON_NUM_CHANNELS,
