...
//----------------------------------------------------------
// Deprecated function marking - fallback implementation is to just ignore.

/*
 Examples: 

 AUD_ATTR_DEPRECATED("Use fixed() instead") void broken();
 AUD_ATTR_DEPRECATED("Use NewType instead") typedef NewType LegacyType;
 */
#ifndef AUD_ATTR_DEPRECATED
#define AUD_ATTR_DEPRECATED(MSG)
#endif 
...
// Interface names
	...
	#define AUD_ENV_HAS_INTERFACE_DESCRIPTION 1
	#define AUD_INTERFACE_DESCRIPTION_LENGTH 256
	typedef wchar_t aud_intf_description_char_t;
		
#else
	#define AUD_INTERFACE_NAME_IS_WCHAR 0
	#define AUD_ENV_HAS_INTERFACE_DESCRIPTION 0
...
#if AUD_ENV_HAS_INTERFACE_DESCRIPTION == 1
/**
	Array to hold name of an interface. 
 */
typedef aud_intf_description_char_t aud_interface_description_t[AUD_INTERFACE_DESCRIPTION_LENGTH + 1];
#endif
