...
/**
* Set all AES67 parameters for the Rx flow from SDP in a text buffer
* @param config flow configuration
* @param sdp_txt SDP text buffer
* @param len if non-zero, specify length of text buffer.  Otherwise assume it is a null-terminated C string.
*/
aud_error_t
dr_rxflow_config_set_aes67_params_from_sdp_txt
(
	dr_rxflow_config_t * config,
	const char * sdp_txt,
	size_t len
